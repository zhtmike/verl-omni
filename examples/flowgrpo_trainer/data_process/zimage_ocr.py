...
Z-Image uses Qwen3 tokenizer with ``enable_thinking=True`` chat template.
The prompt format stores raw message dicts that will be processed through
the tokenizer's ``apply_chat_template`` in the diffusion agent loop.
...
if __name__ == "__main__":
    ...
    # Empty negative prompt for Z-Image-Turbo (CFG disabled by default)
