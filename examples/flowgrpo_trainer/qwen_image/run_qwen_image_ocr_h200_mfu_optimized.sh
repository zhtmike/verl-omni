# Qwen-Image full-weight RL, vllm_omni rollout (H200 Optimized)
set -x
...
# SP=1 avoids all-to-all overheads. With offload disabled, memory is sufficient.
ACTOR_SP=1
ROLLOUT_TP=1
REWARD_TP=4
...
python3 -m verl_omni.trainer.main_diffusion \
    ...
    trainer.experiment_name=qwen_image_ocr_h200 \
